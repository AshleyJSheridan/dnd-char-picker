...
export const Backgrounds = [
    {
        ...
        proficiencies: [Skills.INSIGHT, Skills.RELIGION],
        extraLanguages: 2,
        equipment: [InventoryItems.HOLY_SYMBOL, InventoryItems.PRAYER_BOOK, InventoryItems.INCENSE_STICKS, InventoryItems.VESTMENTS, InventoryItems.COMMON_CLOTHES],
        startingGold: 15,
    ...
    },
    {
        ...
        proficiencies: [Skills.DECEPTION, Skills.SLEIGHT_OF_HAND],
        extraLanguages: 0,
        equipment: [InventoryItems.FINE_CLOTHES, InventoryItems.DISGUISE_KIT, InventoryItems.TOOLS_OF_THE_CON],
        startingGold: 15,
        suggestedCharacteristics: {
            personalityTraits: [
        ...
        characterStyles: {
            label: 'Favourite Schemes',
            styles: [
                'I cheat at games of chance.',
                'I shave coins or forge documents.',
                'I insinuate myself into people\'s lives t prey on their weaknesses and secure their fortunes.',
    ...
    },
    {
        ...
        proficiencies: [Skills.DECEPTION, Skills.STEALTH],
        extraLanguages: 0,
        equipment: [InventoryItems.CROWBAR, InventoryItems.COMMON_CLOTHES],
        startingGold: 15,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ACROBATICS, Skills.PERFORMANCE],
        extraLanguages: 0,
        equipment: [InventoryItems.DISGUISE_KIT, InventoryItems.LUTE],
        gold: 15,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ANIMAL_HANDLING, Skills.SURVIVAL],
        extraLanguages: 0,
        equipment: [InventoryItems.SHOVEL, InventoryItems.IRON_POT, InventoryItems.COMMON_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.INSIGHT, Skills.PERSUASION],
        extraLanguages: 1,
        equipment: [InventoryItems.TRAVELERS_CLOTHES],
        startingGold: 15,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.MEDICINE, Skills.RELIGION],
        extraLanguages: 1,
        equipment: [InventoryItems.COMMON_CLOTHES, InventoryItems.HERBALISM_KIT],
        startingGold: 5,
        suggestedCharacteristics: {
            personalityTraits: [
        ...
        characterStyles: {
            ...
            styles: [
                ...
                'I was exciled for a crime I didn\'t commit.',
                'I retreated from society after a life-altering event.',
                'I needed a quiet place to work on my art, literature, music, or manifesto.',
                'I needed to commune with nature, far from civilisation.',
    ...
    },
    {
        ...
        proficiencies: [Skills.HISTORY, Skills.PERSUASION],
        extraLanguages: 1,
        equipment: [InventoryItems.FINE_CLOTHES, InventoryItems.SIGNET_RING],
        startingGold: 25,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ATHLETICS, Skills.SURVIVAL],
        extraLanguages: 1,
        equipment: [InventoryItems.STAFF, InventoryItems.HUNTING_TRAP, InventoryItems.TRAVELERS_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ARCANA, Skills.HISTORY],
        extraLanguages: 0,
        equipment: [InventoryItems.BLACK_INK, InventoryItems.QUILL, InventoryItems.SMALL_KNIFE, InventoryItems.COMMON_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ATHLETICS, Skills.PERCEPTION],
        extraLanguages: 0,
        equipment: [InventoryItems.CLUB, InventoryItems.ROPE_SILK, InventoryItems.COMMON_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.ATHLETICS, Skills.INTIMIDATION],
        extraLanguages: 0,
        equipment: [InventoryItems.DAGGER, InventoryItems.COMMON_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
    ...
    },
    {
        ...
        proficiencies: [Skills.SLEIGHT_OF_HAND, Skills.STEALTH],
        extraLanguages: 0,
        equipment: [InventoryItems.SMALL_KNIFE, InventoryItems.COMMON_CLOTHES],
        startingGold: 10,
        suggestedCharacteristics: {
            personalityTraits: [
